...
def get_daily_steps():
    ...
    step_list = steps.split()  # ✅ corregido
...
def goal_check(nums, goal=10000):
    ...
    for s in nums:
        if s >= goal:
            result.append(True)   # ✅ corregido
        else:
            result.append(False)  # ✅ corregido
    return result
